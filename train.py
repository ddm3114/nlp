...
from utlis import read_sample,transform,save_dict,load_dict,process_text
import json
...
def train(hyperparameters):
    ...
    AutoCast = args['autocast'] if 'autocast' in args else False
    ...
    if augment:
        train_dataloader,val_dataloader,augment_dataloader = get_dataloader(dataset = dataset,batch_size=batch_size,augment = augment,data_root=data_root,data_type=data_type)
    else:
        train_dataloader,val_dataloader = get_dataloader(dataset = dataset,batch_size=batch_size,augment = augment,data_root=data_root,data_type=data_type)
